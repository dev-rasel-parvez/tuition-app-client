...
const TutorDetails = () => {
  ...
  if (!tutor) {
    return (
      <div className="text-center text-red-500 text-xl mt-20">Tutor not found</div>
    );
  }
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center text-center">
        ...
        <p className="text-gray-600"> <strong >Tutor University: </strong> {tutor.university}</p>
        <p className="text-gray-600"> <strong >Tutor Department: </strong> {tutor.department}</p>
